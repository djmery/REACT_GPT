...
export const GptMessageSelectableImage = ({ imageUrl, onImageSelected }: Props) => {
    ...
    useEffect(() => {
        ...
        const image = new Image(); // imagen html en la parte de javascript, creo una imagen en memoria y manteniendo el contexto donde vamos a dibujar
        image.crossOrigin = 'Anonymous'; // hay que editar el cross en nuestro backend
        image.src = imageUrl;
    ...
    return (
        <div className="col-start-1 col-end-8 p-3 rounded-lg">
            <div className="flex flex-row items-start">
                <div className="flex items-center justify-center h-10 w-10 rounder-full bg-green-600 flex-shrink-0">
                    G
                </div>
